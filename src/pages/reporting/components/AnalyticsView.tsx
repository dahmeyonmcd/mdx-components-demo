        ...
        <div className="stats shadow bg-[#282828] flex flex-row px-6 py-4 rounded-[12px]">
            <div className="stat flex flex-row items-center justify-start gap-3">
                <div className={'flex flex-col '}>
                    <div className="stat-title text-white text-[13px]"><strong>Total Likes</strong></div>
            ...
            <div className="stat flex flex-row items-center justify-start gap-3">
                <div className={'flex flex-col justify-start'}>
                    ...
                    <div className="text-[13px] stat-title text-white">Tasks done</div>
                    <div style={{fontFamily: 'Pixidot', fontWeight: 400}} className="stat-desc text-secondary text-[13px]">31 tasks remaining</div>
                </div>
